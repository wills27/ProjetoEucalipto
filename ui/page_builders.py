...
class UiBuilderMixin:
    ...
    def build_dataset_section(self, layout, show_import_actions=True):
        ...
        self.dataset_pairs_table = DatasetPairsTable(self.delete_selected_dataset_pair, 0, 6)
        self.dataset_pairs_table.setHorizontalHeaderLabels(["Sel.", "#", "Usar", "Grupo", "Imagem", "Status"])
        ...
        self.dataset_pairs_table.horizontalHeader().setSectionResizeMode(4, QHeaderView.ResizeMode.Stretch)
        ...
        self.dataset_pairs_table.itemChanged.connect(self.on_dataset_table_item_changed)
        self.dataset_pairs_table.currentCellChanged.connect(self.on_dataset_pair_current_cell_changed)
        self.dataset_pairs_table.select_visible_callback = self.select_visible_dataset_rows_for_action
        self.dataset_pairs_table.clear_action_selection_callback = self.clear_dataset_action_selection
        ...
        self.add_button(validation_actions, "Exportar pastas", self.run_prepare_dataset)
        self.add_button(validation_actions, "Selecionar visiveis", self.select_visible_dataset_rows_for_action)
        self.add_button(validation_actions, "Inverter visiveis", self.invert_visible_dataset_action_selection)
        self.add_button(validation_actions, "Limpar marcadas", self.clear_dataset_action_selection)
